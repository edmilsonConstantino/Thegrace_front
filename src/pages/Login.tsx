              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <Link to="/recuperar-senha" className="text-[#00BFA5] hover:underline">
                      Esqueceu a senha?
                    </Link>
                  </div>
                  <Button type="submit" className="w-full bg-[#00BFA5] hover:bg-[#00BFA5]/90" size="lg">
                    Entrar
                  </Button>
                </form>
                ...
                <div className="mt-6 text-center text-sm">
                  ...
                  <Link to="/registrar" className="text-[#9C27B0] hover:underline font-semibold">
                    Registre-se
                  </Link>
                </div>
