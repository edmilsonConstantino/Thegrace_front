...
import { MapPin, Phone, Mail, Clock, Send, MessageSquare, Lightbulb, AlertTriangle, CheckCircle2 } from 'lucide-react';
...
const faqItems = [
  {
    ...
    answer: 'Você pode se tornar membro clicando em "Seja Membro" no menu principal. O processo é simples e leva apenas alguns minutos.',
  },
  {
    question: 'Quais são os benefícios de ser membro?',
    answer: 'Membros têm acesso a eventos exclusivos, workshops, networking com outros membros e a oportunidade de participar ativamente das iniciativas da associação.',
  },
  {
    question: 'Como posso fazer uma doação?',
    answer: 'Aceitamos doações através de transferência bancária, cartão de crédito ou MB Way. Visite nossa página de doações para mais informações.',
  },
  {
    question: 'Posso ser voluntário sem ser membro?',
    answer: 'Sim! Temos programas de voluntariado abertos a todos. Entre em contato conosco para conhecer as oportunidades disponíveis.',
  },
];
                  ...
                  <CardContent>
                    <Tabs value={formType} onValueChange={setFormType} className="w-full">
                      <TabsList className="grid grid-cols-3 mb-6">
                        <TabsTrigger value="contact" className="data-[state=active]:bg-[#00BFA5] data-[state=active]:text-white">
                          <MessageSquare className="mr-2" size={16} />
                          Contato
                        </TabsTrigger>
                        <TabsTrigger value="suggestion" className="data-[state=active]:bg-[#00BFA5] data-[state=active]:text-white">
                          <Lightbulb className="mr-2" size={16} />
                          Sugestão
                        </TabsTrigger>
                        <TabsTrigger value="complaint" className="data-[state=active]:bg-[#00BFA5] data-[state=active]:text-white">
                            ...
                            <div className="space-y-2">
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="membership">Associação</SelectItem>
                    ...
                    {faqItems.map((item, index) => (
                      <details key={index} className="group">
                        <summary className="flex items-center justify-between cursor-pointer p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                          ...
                          <span className="text-[#00BFA5] group-open:rotate-180 transition-transform">
                            ▼
                          </span>
                        </summary>
